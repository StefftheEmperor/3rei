...
class Statement implements \Iterator, \Countable {
	...
	public function set_query(\Db\Mysql\Query $query)
	{
		$this->query = $query;
	}
	public function next()
	{
		...
		if ($this->get_query() instanceof \Db\Mysql\Query AND $this->get_query()->is_select() AND $this->get_query()->get_from() instanceof \Db\Table)
		{
